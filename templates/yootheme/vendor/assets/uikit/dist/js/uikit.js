...
function listen(cb) {
    ...
    return promise(function (resolve) {
        ...
        one(window, 'message', function (data) { return resolve(data); }, false, function (ref) {
            var data = ref.data;
        ...
        toggleElement: function toggleElement(targets, show, animate) {
            ...
            return promise(function (resolve) {
                ...
                var body = document.body,
                    ...
                    all = function (targets) { return promise.all(targets.map(function (el) { return this$1._toggleElement(el, show, animate); })); };
                ...
                if (!inProgress) {
                    p = p.then(function () {
                        ...
                        return all(targets.filter(function (el) { return !~toggled.indexOf(el); }));
                    });
                }
