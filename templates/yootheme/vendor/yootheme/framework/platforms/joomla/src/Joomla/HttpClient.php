...
class HttpClient implements HttpClientInterface
{
    ...
    {
        $response = (array) \JHttpFactory::getHttp(new Registry($options ?: []))->get($url);
    ...
    {
        $response = (array) \JHttpFactory::getHttp(new Registry($options ?: []))->post($url, $data);
    ...
    {
        $response = (array) \JHttpFactory::getHttp(new Registry($options ?: []))->put($url, $data);
    ...
    {
        $response = (array) \JHttpFactory::getHttp(new Registry($options ?: []))->delete($url);
