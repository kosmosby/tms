...
if ($element['lightbox']) {
    ...
    if ($ext = $this->isImage($item['link'])) {

        if (($element['lightbox_image_width'] || $element['lightbox_image_height']) && $ext != 'svg') {
    ...
    } elseif ($this->isVideo($item['link']) || $this->iframeVideo($item['link'])) {
